...
<template>
  <div class="text-section">
    <NavBar />
    <main v-scroll-spy class="container my-5">
      <section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            卒業後、メーカー系システムインテグレーターに就職。14年間勤務。
          </li>
          <li>
            プロジェクトマネージャーをやるよりエンジニアとして多彩な仕事・システム・プログラミング言語に触れたかったため、2023年に独立。
          </li>
      ...
      <section>
        <h2 id="skills">スキル</h2>
        <p>
          技術オタクなので新しい言語やフレームワークを触るのは大好きです。<br />
